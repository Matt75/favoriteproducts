...
class DeleteFavoriteProductCommandTest extends TestCase
{
    public function testCommandIsCreatedSuccessfullyWhenValidPropertiesAreGiven()
    {
        ...
        $this->assertInstanceOf(DeleteFavoriteProductCommand::class, $this->createCommandFromArray($validDataArray));
    }
    ...
    {
        return new DeleteFavoriteProductCommand(
            $data['customerId'],
            $data['productId'],
            $data['shopId']
        );
